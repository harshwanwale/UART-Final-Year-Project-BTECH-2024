...
HD_PWD='C:/Users/Harsh/Desktop/My Project/Uart_top_QUARTUS_totally_working-vivado simulation/quartus_working_viavado/quartus_working_viavado.runs/synth_1'
cd "$HD_PWD"
